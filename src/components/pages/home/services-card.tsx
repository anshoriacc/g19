...
const ServicesCard = ({ type }: Props) => {
  return (
    <Link
      ...
      <h3
        className={cn(
          "bg-gradient-to-b from-neutral-900 from-60% bg-clip-text text-3xl font-bold text-transparent dark:from-neutral-50",
      ...
      <p className="absolute left-8 top-20 w-[304px] translate-x-10 translate-y-10 text-neutral-500 opacity-0 transition-all delay-200 duration-200 group-hover:visible group-hover:top-20 group-hover:translate-x-0 group-hover:translate-y-0 group-hover:opacity-100">
